        ...
        <div className="container">
          ...
          <Tiles>
            <div title="Balance" image="values/balance.svg">
              <p style={{color:'white'}}>Whether it be diet, beliefs, how much we sleep or the amount we drink, we should strive to not devolve into excess.
            ...
            <div title="Persistence" image="values/persistence.svg">
              <p style={{color:'white'}}>Improvement can only be achieved through practice, and to change ourselves, we have to challenge ourselves.
            ...
            <div title="Presence" image="values/presence.svg">
              <p style={{color:'white'}}>Carpe diem, as the saying goes (YOLO the modern equivalent).
            ...
            <div title="Humanity" image="values/humanity.svg">
              <p style={{color:'white'}}>It's easy to dismiss people we disagree with as "stupid" or "bigoted". I think we should all try to understand where people come
            ...
            <div title="Skepticism" image="values/skepticism.svg">
              <p style={{color:'white'}}>It can be hard to realise, given our trust in modern science, that nothing claimed to be known is truly known.
            ...
            <div title="Realism" image="values/realism.svg">
              <p style={{color:'white'}}>The best we can hope for, and what the scientific method aims to do, is to iteratively improve our model of the universe.
            ...
            <div title="Explore" image="values/explore.svg">
              <p style={{color:'white'}}>We should always be searching for new places, ideas, philosophies and ways of thinking. It is naïve to believe that you 
            ...
            <div title="Create" image="values/create.svg">
              <p style={{color:'white'}}>It's liberating to express yourself. Putting our true experience down on (metaphorical) paper allows us to understand ourselves better,
            ...
            <div title="Bond" image="values/bond.svg">
              <p style={{color:'white'}}>It's hard to concieve of something more complicated and beautiful than the mind. When multiple minds interact, however, they can
